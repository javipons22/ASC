...
{ //wpt es un nombre dado por nosotros para diferenciar con otros plugins
    ...
    wp_enqueue_style('main_css', get_template_directory_uri() . '/style.4.css',array(),"2.3.0");
    wp_enqueue_style('laptop_media', get_template_directory_uri() . '/css/laptop.2.css',array(),"2.1.0");
}
...
function wpt_theme_js()
{
    ...
    wp_enqueue_script('main_js', get_template_directory_uri() . '/js/script.3.js', array('jquery'), '2.0.0', true);
