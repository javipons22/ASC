...
function wpt_theme_styles() { //wpt es un nombre dado por nosotros para diferenciar con otros plugins
    ...
    wp_enqueue_style( 'main_css', get_template_directory_uri() . '/style.css?version=1' );
    wp_enqueue_style( 'laptop_media', get_template_directory_uri() . '/css/laptop.css?version=1' );
}
add_action( 'wp_enqueue_scripts', 'wpt_theme_styles' );


function wpt_theme_js() {
    wp_enqueue_script('main_js', get_template_directory_uri() . '/js/script.js?version=1', array('jquery') , '' , true);
