...
{ //wpt es un nombre dado por nosotros para diferenciar con otros plugins
    ...
    wp_enqueue_style('main_css', get_template_directory_uri() . '/style.css',array(),"1.5.1");
    wp_enqueue_style('laptop_media', get_template_directory_uri() . '/css/laptop.css',array(),"1.5.1");
}
...
function wpt_theme_js()
{
    ...
    wp_enqueue_script('main_js', get_template_directory_uri() . '/js/script.js', array('jquery'), '1.5.1', true);
