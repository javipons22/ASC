...
{ //wpt es un nombre dado por nosotros para diferenciar con otros plugins
    ...
    wp_enqueue_style('main_css', get_template_directory_uri() . '/style.css',array(),"2.0.0");
    wp_enqueue_style('laptop_media', get_template_directory_uri() . '/css/laptop.css',array(),"2.0.0");
}
...
function wpt_theme_js()
{
    ...
    wp_enqueue_script('main_js', get_template_directory_uri() . '/js/script.js', array('jquery'), '2.0.0', true);
