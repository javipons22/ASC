...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $img_path; ?>/apple-touch-icon.png">
    ...
    <link rel="manifest" href="<?php echo $img_path; ?>/site.webmanifest">
    <link rel="mask-icon" href="<?php echo $img_path; ?>/safari-pinned-tab.svg" color="#5bbad5">
